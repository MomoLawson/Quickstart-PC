...
Opzioni:
  ...
  doctor --fix        Ripara automaticamente le dipendenze mancanti
...
LANG_UPDATE_CHECKING="Verifica aggiornamenti..."
LANG_UPDATE_AVAILABLE="Nuova versione disponibile: %s (attuale: %s)"
LANG_UPDATE_LATEST="Già sull'ultima versione"
LANG_UPDATE_DOWNLOADING="Download aggiornamento..."
LANG_UPDATE_SUCCESS="Aggiornamento riuscito! Riavviare lo script"
LANG_UPDATE_FAILED="Aggiornamento fallito: %s"
LANG_UPDATE_PROMPT="Aggiornare alla nuova versione? [Y/n]"
LANG_UPDATE_CTRL_U="Nuova versione %s disponibile. Premi Ctrl+U per aggiornare"
LANG_HOOK_RUNNING="Esecuzione hook: %s"
LANG_HOOK_SUCCESS="Hook completato"
LANG_HOOK_FAILED="Hook fallito: %s"
LANG_HOOKS_DISABLED="Hook disabilitati, usa --allow-hooks per abilitare"
LANG_HOOKS_ENABLED="Hook abilitati"
LANG_BATCH_INSTALLING="Installazione batch di %d pacchetti..."
