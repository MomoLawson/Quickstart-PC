...
Opzioni:
  ...
  --dry-run          Simulazione: mostra processo senza installare
...
LANG_FAKE_INSTALL_MODE="Modalità simulazione: mostra processo di installazione senza installare realmente"
LANG_FAKE_INSTALLING="Simulazione in corso"
