...
LANG_RETRY_PROMPT="재시도하시겠습니까? [Y/n]"
LANG_RETRYING="재시도 중"
LANG_ERROR_DETAIL="오류 상세"
LANG_CUSTOM_TITLE="사용자 정의 소프트웨어 선택"
LANG_CUSTOM_SPACE_TOGGLE="스페이스: 선택 전환"
LANG_CUSTOM_ENTER_CONFIRM="Enter: 확인"
LANG_CUSTOM_A_SELECT_ALL="A: 전체 선택/해제"
LANG_CUSTOM_SELECTED="선택됨 %d/%d"
LANG_DISK_SPACE_LOW="디스크 공간 부족: 사용 가능 %sGB, 최소 %sGB 권장"
LANG_DISK_SPACE_WARNING="⚠ 디스크 공간이 부족하여 설치가 실패할 수 있습니다"
LANG_DISK_CHECKING="디스크 공간 확인 중..."
LANG_NETWORK_TIMEOUT="네트워크 연결 시간 초과, 네트워크 설정을 확인하세요"
LANG_NETWORK_ERROR="네트워크 오류: %s"
LANG_CHECK_NETWORK="제안: 네트워크 연결을 확인하거나 프록시를 설정하세요"
LANG_PERMISSION_DENIED="권한이 없습니다: %s"
LANG_PERMISSION_SUGGESTION="제안: sudo로 실행하거나 관리자에게 문의하세요"
LANG_NEED_SUDO="이 작업에는 관리자 권한이 필요합니다"
LANG_NEED_ADMIN="관리자로 실행해 주세요"
LANG_RESUME_FOUND="미완료된 설치가 발견되었습니다. 계속하시겠습니까？[Y/n]"
LANG_RESUMING="이전 체크포인트에서 재개..."
LANG_CHECKPOINT_SAVED="설치 진행 상태가 저장되었습니다"
LANG_INSTALL_COMPLETE_STATE="설치 완료, 임시 파일 정리"
LANG_UPDATE_CHECKING="업데이트 확인 중..."
LANG_UPDATE_AVAILABLE="새 버전 사용 가능: %s (현재: %s)"
LANG_UPDATE_LATEST="최신 버전입니다"
LANG_UPDATE_DOWNLOADING="업데이트 다운로드 중..."
LANG_UPDATE_SUCCESS="업데이트 성공! 스크립트를 다시 실행하세요"
LANG_UPDATE_FAILED="업데이트 실패: %s"
LANG_UPDATE_PROMPT="새 버전으로 업데이트하시겠습니까？[Y/n]"
LANG_UPDATE_CTRL_U="새 버전 %s 사용 가능. Ctrl+U로 업데이트"
LANG_HOOK_RUNNING="후크 실행: %s"
LANG_HOOK_SUCCESS="후크 실행 완료"
LANG_HOOK_FAILED="후크 실행 실패: %s"
LANG_HOOKS_DISABLED="후크 스크립트가 비활성화되었습니다, --allow-hooks를 사용하여 활성화하세요"
LANG_HOOKS_ENABLED="후크 스크립트가 활성화되었습니다"
LANG_BATCH_INSTALLING="%d개 패키지 일괄 설치 중..."
LANG_BATCH_SUCCESS="일괄 설치 완료: %d/%d 성공"
