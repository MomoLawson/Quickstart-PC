...
選項:
  ...
  --show-profile KEY 顯示指定預設詳情
  --skip SW          跳過指定軟體（可多次使用）
  --only SW          只安裝指定軟體（可多次使用）
  --fail-fast        遇到錯誤時立即停止
  --profile NAME     直接指定安裝預設（跳過選擇菜單）
...
LANG_NOT_SELECTED="[  ] "
LANG_SELECT_ALL="全選"
LANG_BACK_TO_PROFILES="返回預設選擇"
LANG_NO_PROFILE_SELECTED="未選擇任何預設"
...
LANG_ASK_CONTINUE="安裝完成，是否繼續安裝其他預設？"
LANG_CONTINUE="繼續安裝"
LANG_EXIT="退出"
LANG_TITLE_SELECT_PROFILE="選擇預設"
...
LANG_UPDATE_CHECKING="檢查更新..."
LANG_UPDATE_AVAILABLE="發現新版本: %s (目前: %s)"
LANG_UPDATE_LATEST="已是最新版本"
LANG_UPDATE_DOWNLOADING="下載更新..."
LANG_UPDATE_SUCCESS="更新成功！請重新執行腳本"
LANG_UPDATE_FAILED="更新失敗: %s"
LANG_UPDATE_PROMPT="是否更新到新版本？[Y/n]"
LANG_UPDATE_CTRL_U="發現新版本 %s，按 Ctrl+U 更新"
LANG_HOOK_RUNNING="執行鉤子: %s"
LANG_HOOK_SUCCESS="鉤子執行完成"
LANG_HOOK_FAILED="鉤子執行失敗: %s"
LANG_HOOKS_DISABLED="鉤子腳本已禁用，使用 --allow-hooks 啟用"
LANG_HOOKS_ENABLED="鉤子腳本已啟用"
LANG_BATCH_INSTALLING="批量安裝 %d 個軟體..."
LANG_BATCH_SUCCESS="批量安裝完成: %d/%d 成功"
LANG_BATCH_FAILED="批量安裝部分失敗，回退逐個安裝..."
LANG_BYE="Quickstart-PC 已退出，再見！"


LANG_CONFIG_VERIFY_FAILED="設定檔校驗失敗"
LANG_CONFIG_CHECKSUM_NOT_FOUND="校驗檔案不存在"
LANG_CONFIG_CHECKSUM_MISMATCH="校驗值不匹配"
LANG_CONFIG_VERIFY_SUCCESS="設定檔校驗成功"
