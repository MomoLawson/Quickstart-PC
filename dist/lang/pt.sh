...
Opções:
  ...
  --dry-run          Simulação: mostrar processo sem instalar
  --fake-install     Alias para --dry-run (obsoleto)
...
LANG_FAKE_INSTALL_MODE="Modo simulação: mostrar processo de instalação sem instalar realmente"
