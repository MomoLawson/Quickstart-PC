...
LANG_UPDATE_AVAILABLE="New version available: %s (current: %s)"
LANG_UPDATE_LATEST="Already on the latest version"
LANG_UPDATE_DOWNLOADING="Downloading update..."
LANG_UPDATE_SUCCESS="Update successful! Please restart the script"
LANG_UPDATE_FAILED="Update failed: %s"
LANG_UPDATE_PROMPT="Update to new version? [Y/n]"
LANG_UPDATE_CTRL_U="New version %s available. Press Ctrl+U to update"
LANG_HOOK_RUNNING="Running hook: %s"
LANG_HOOK_SUCCESS="Hook completed"
LANG_HOOK_FAILED="Hook failed: %s"
LANG_HOOKS_DISABLED="Hooks disabled, use --allow-hooks to enable"
LANG_HOOKS_ENABLED="Hooks enabled"
LANG_BATCH_INSTALLING="Batch installing %d packages..."
LANG_BATCH_SUCCESS="Batch install complete: %d/%d succeeded"
