...
Optionen:
  ...
  --dry-run          Simulation: Prozess anzeigen ohne Installation
...
LANG_FAKE_INSTALL_MODE="Simulationsmodus: Installationsprozess anzeigen ohne tatsächliche Installation"
LANG_FAKE_INSTALLING="Simulation läuft"
