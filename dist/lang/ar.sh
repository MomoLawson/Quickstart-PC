...
LANG_NPM_AUTO="npm"
LANG_INSTALL_FAILED_LIST="فشل تثبيت البرامج التالية"
LANG_PROGRESS_INSTALLED="مثبت"
LANG_PROGRESS_TO_INSTALL="للتثبيت"
LANG_TIME_SECONDS="ث"
LANG_TIME_TOTAL="الوقت الإجمالي"
LANG_RETRY_PROMPT="إعادة المحاولة؟ [Y/n]"
LANG_RETRYING="إعادة المحاولة"
LANG_ERROR_DETAIL="تفاصيل الخطأ"
LANG_CUSTOM_TITLE="الاختيار المخصص"
LANG_CUSTOM_SPACE_TOGGLE="مسافة: تبديل"
LANG_CUSTOM_ENTER_CONFIRM="Enter: تأكيد"
LANG_CUSTOM_A_SELECT_ALL="A: تحديد/إلغاء تحديد الكل"
LANG_CUSTOM_SELECTED="تم الاختيار %d/%d"
LANG_DISK_SPACE_LOW="مساحة قرص غير كافية: %sGB متاح، يوصى بـ %sGB على الأقل"
LANG_DISK_SPACE_WARNING="⚠ مساحة القرص منخفضة، قد يفشل التثبيت"
LANG_DISK_CHECKING="جاري التحقق من مساحة القرص..."
LANG_NETWORK_TIMEOUT="انتهت مهلة اتصال الشبكة، يرجى التحقق من إعدادات الشبكة"
LANG_NETWORK_ERROR="خطأ في الشبكة: %s"
LANG_CHECK_NETWORK="اقتراح: تحقق من اتصال الشبكة أو قم بإعداد وكيل"
LANG_PERMISSION_DENIED="تم رفض الإذن: %s"
LANG_PERMISSION_SUGGESTION="اقتراح: تشغيل مع sudo أو الاتصال بالمسؤول"
LANG_NEED_SUDO="تتطلب هذه العملية امتيازات المسؤول"
LANG_NEED_ADMIN="يرجى التشغيل كمسؤول"
LANG_RESUME_FOUND="تم العثور على تثبيت غير مكتمل. المتابعة؟ [Y/n]"
LANG_RESUMING="استئناف من آخر نقطة تحقق..."
LANG_CHECKPOINT_SAVED="تم حفظ تقدم التثبيت"
LANG_INSTALL_COMPLETE_STATE="اكتمل التثبيت، تنظيف الملفات المؤقتة"
LANG_UPDATE_CHECKING="التحقق من التحديثات..."
LANG_UPDATE_AVAILABLE="يتوفر إصدار جديد: %s (الحالي: %s)"
LANG_UPDATE_LATEST="أنت على أحدث إصدار"
LANG_UPDATE_DOWNLOADING="تحميل التحديث..."
LANG_UPDATE_SUCCESS="تم التحديث بنجاح! يرجى إعادة تشغيل البرنامج النصي"
LANG_UPDATE_FAILED="فشل التحديث: %s"
LANG_UPDATE_PROMPT="هل تريد التحديث إلى الإصدار الجديد؟ [Y/n]"
LANG_UPDATE_CTRL_U="إصدار جديد %s متاح. اضغط Ctrl+U للتحديث"
LANG_HOOK_RUNNING="تشغيل البرنامج النصي: %s"
LANG_HOOK_SUCCESS="اكتمل البرنامج النصي"
LANG_HOOK_FAILED="فشل البرنامج النصي: %s"
LANG_HOOKS_DISABLED="البرامج النصية معطلة، استخدم --allow-hooks للتمكين"
LANG_HOOKS_ENABLED="البرامج النصية ممكنة"
LANG_BATCH_INSTALLING="تثبيت %d حزمة دفعة واحدة..."
...
LANG_CONFIG_VERIFY_FAILED="فشل التحقق من التكوين"
LANG_CONFIG_CHECKSUM_NOT_FOUND="ملف التحقق غير موجود"
LANG_CONFIG_CHECKSUM_MISMATCH="عدم تطابق التحقق"
LANG_CONFIG_VERIFY_SUCCESS="نجح التحقق من التكوين"
