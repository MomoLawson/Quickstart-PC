...
LANG_DISK_SPACE_LOW="ディスク容量不足: 利用可能 %sGB、最低 %sGB 推奨"
LANG_DISK_SPACE_WARNING="⚠ ディスク容量が少ないため、インストールに失敗する可能性があります"
LANG_DISK_CHECKING="ディスク容量を確認中..."
LANG_NETWORK_TIMEOUT="ネットワーク接続がタイムアウトしました。ネットワーク設定を確認してください"
LANG_NETWORK_ERROR="ネットワークエラー: %s"
LANG_CHECK_NETWORK="提案: ネットワーク接続を確認するかプロキシを設定してください"
LANG_PERMISSION_DENIED="権限がありません: %s"
LANG_PERMISSION_SUGGESTION="提案: sudo で実行するか管理者に連絡してください"
LANG_NEED_SUDO="この操作には管理者権限が必要です"
LANG_NEED_ADMIN="管理者として実行してください"
LANG_RESUME_FOUND="未完了のインストールが見つかりました。続行しますか？[Y/n]"
LANG_RESUMING="前回のチェックポイントから再開..."
LANG_CHECKPOINT_SAVED="インストール進捗が保存されました"
LANG_INSTALL_COMPLETE_STATE="インストール完了、一時ファイルをクリーンアップ"
LANG_UPDATE_CHECKING="アップデートを確認中..."
LANG_UPDATE_AVAILABLE="新しいバージョンがあります: %s (現在: %s)"
LANG_UPDATE_LATEST="最新バージョンです"
LANG_UPDATE_DOWNLOADING="アップデートをダウンロード中..."
LANG_UPDATE_SUCCESS="アップデート成功！スクリプトを再起動してください"
LANG_UPDATE_FAILED="アップデート失敗: %s"
LANG_UPDATE_PROMPT="新しいバージョンに更新しますか？[Y/n]"
LANG_UPDATE_CTRL_U="新しいバージョン %s があります。Ctrl+U で更新"
LANG_HOOK_RUNNING="フックを実行: %s"
LANG_HOOK_SUCCESS="フックの実行が完了しました"
LANG_HOOK_FAILED="フックの実行に失敗しました: %s"
LANG_HOOKS_DISABLED="フックスクリプトは無効です、--allow-hooks を使用して有効にしてください"
LANG_HOOKS_ENABLED="フックスクリプトが有効になりました"
LANG_BATCH_INSTALLING="%d 個のパッケージを一括インストール中..."
